...
export function FamilyDetailsDialogRefined({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        <div className="relative overflow-hidden rounded-[1.75rem] bg-[linear-gradient(180deg,rgba(255,255,255,0.98)_0%,rgba(247,251,250,0.98)_100%)] shadow-[0_36px_90px_-40px_rgba(14,52,48,0.38)] ring-1 ring-slate-200/70">
