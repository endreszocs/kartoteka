...
CREATE TABLE public.befizetes (
  ...
  CONSTRAINT befizetes_id_csalad_fk FOREIGN KEY (id_csalad) REFERENCES public.csalad(id)
);
...
CREATE TABLE public.csoport (
  ...
  CONSTRAINT csoport_congregation_id_fkey FOREIGN KEY (congregation_id) REFERENCES public.congregations(id)
);
...
CREATE TABLE public.felmentes (
  ...
  CONSTRAINT felmentes_congregation_id_fkey FOREIGN KEY (congregation_id) REFERENCES public.congregations(id)
);
...
CREATE TABLE public.presbiter (
  ...
  CONSTRAINT presbiter_congregation_id_fkey FOREIGN KEY (congregation_id) REFERENCES public.congregations(id)
);
...
CREATE TABLE public.sirhelyelhunyt (
  ...
  CONSTRAINT sirhelyelhunyt_id_szemely_fkey FOREIGN KEY (id_szemely) REFERENCES public.szemely(id)
);
...
CREATE TABLE public.szemely (
  ...
  voter_manual_override smallint CHECK (voter_manual_override = ANY (ARRAY[0, 1])),
  social_profil_url text,
...
CREATE TABLE public.jarulek_kedvezmeny (
  ...
  congregation_id uuid NOT NULL,
  ev integer NOT NULL,
  tipus text NOT NULL CHECK (tipus = ANY (ARRAY['idoszak'::text, 'kor'::text, 'jovedelem'::text, 'foglalkozas'::text])),
