...
--     kanonikus törzs: migration-docs/sql/2026-09-04-auth-p0-javitasok-1.sql
--     ha mégis lefut: a felhasználókezelő RPC-család kapuja status-vakká válna
--   · current_user_has_global_access()
--     kanonikus törzs: migration-docs/sql/2026-08-11-globalis-hozzaferes-szukites.sql
--     ha mégis lefut: az országos hozzáférés gerince (~50 tábla RLS-e) status-vakká válna
--
