/**
 * PageHero — közös prémium fejléc a desktop oldalakhoz.
 *
 * A webes FinanceTabs / FamilyDetailsDialogRefined feel-jét hozza át
 * a desktopra: gradient-háttér + blur-dekoráció + avatar-box + eyebrow-kategória.
 * A cél, hogy minden oldal fejléce egységesen nézzen ki, és pixel-közelben
 * legyen a webes UI-hoz.
 *
 * Példa:
 *   <PageHero
 *     eyebrow="Pénzügy"
 *     title="Befizetés rögzítése"
 *     description="Új befizetés rögzítése a gyülekezeti nyilvántartásba."
 *     Icon={Receipt}
 *     actions={<Button>Új</Button>}
 *   />
 */
