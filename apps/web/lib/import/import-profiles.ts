...
export const PROFILE_BURIAL: ImportProfile = {
  ...
  columnMap: [
    ...
    { excelHeader: 'Született', excelAliases: ['sz_datum'], dbColumn: '_sz_datum', type: 'date', required: false },
    { excelHeader: 'Férfi', excelAliases: ['ferfi', 'Nem'], dbColumn: '_ferfi', type: 'boolean', required: false },
    { excelHeader: 'Halál dátuma', excelAliases: ['hdatum', 'Elhalálozás', 'Halál ideje', 'Dátum', 'Halál dátum', 'Elhalálozás dátuma'], dbColumn: 'hdatum', type: 'date', required: true },
    ...
    { excelHeader: 'Lelkész', excelAliases: ['lelkeszneve', 'Temetőlelkész', 'Lelkész neve', 'Temető lelkész'], dbColumn: 'lelkeszneve', type: 'string', required: false },
