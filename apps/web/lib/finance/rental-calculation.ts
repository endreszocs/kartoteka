...
import type { RentalContractRow, RentalDebtRow, RentalTipus } from '@/lib/constants/finance'
 ...
 * - Éves ciklus: `osszeg`
 */
export function calculateEvesDij(contract: Pick<RentalContractRow, 'osszeg' | 'fizetesi_ciklus'>): number {
  const osszeg = toNum(contract.osszeg)
