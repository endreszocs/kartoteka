...
// 2026-05-30 v2: a KÉK template most már az EREK szövegtartalmával (hosszú
// paragrafus + testvérünket + LELKIPÁSZTOR/GONDNOK aláírások) — a kék-fehér
// népi díszítésű háttéren. Az eredeti KÉK spec (Ezennel örömmel + intro+
// igevers + Lelkész/Keresztszülők) lecserélve user-kérésre.
const KERESZTELESI_KEK_FIELDS: EmleklapField[] = [
  // Gyülekezet neve felül (mint EREK-en)
  {
    id: 'congregationName',
    label: 'Gyülekezet neve (felső sor)',
    defaultValue: '{{congregationName}}',
  ...
  // Főcím KERESZTELÉSI EMLÉKLAP (text-field, a háttéren nincs benne)
  {
    id: 'title',
    label: 'Főcím',
  ...
  // 2026-05-30 v2: fullName MULTILINE — hosszú nevek (pl. KÁDÁR VIKTÓRIA-OLIVIA)
  // most már sortörnek és nem lógnak ki a díszes keretből. Kisebb betűköz +
  // fontSize is, hogy 1 sorba még férjen, de a 2 soros wrap is szép.
  {
    id: 'fullName',
    ...
    letterSpacing: 0.06,
    textTransform: 'uppercase',
    multiline: true, // hosszú nevek auto-wrap
  },
  // "testvérünket" italic kis sor (mint EREK)
  {
    id: 'relativeLabel',
    label: '„testvérünket" felirat',
    defaultValue: 'testvérünket',
  ...
  // 2026-05-30 v2: EREK paragraph szerkezet — szülők + születés + keresztség
  {
    id: 'paragraph',
    label: 'Fő szöveg (5-6 sor)',
    defaultValue: '{{parentsNames}} gyermekét, aki {{birthPlace}} született {{birthDate}}, és akit a {{baptismCongregation}} {{baptismDate}} a szent keresztség által az Atya, Fiú, Szentlélek Isten szövetségébe, a keresztyén Anyaszentegyházba befogadtunk.',
  ...
  // 2026-05-30 v2: aláírás-mezők EREK módjára — LELKIPÁSZTOR + GONDNOK
  {
    id: 'pastorName',
    label: 'Lelkipásztor neve',
    defaultValue: '{{pastorName}}',
