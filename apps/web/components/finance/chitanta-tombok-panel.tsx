  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-start gap-2 rounded-xl border border-amber-300 bg-amber-50 px-3 py-2 text-xs text-amber-800">
        ...
        <p>
          <strong>Tesztidőszak:</strong> a nyugtatömb-rögzítés és a nyugta-nyomtatás jelenleg
          <strong> fejlesztés/kipróbálás alatt</strong> áll, ezért <strong>hivatalos használata
          MÉG NEM MEGENGEDETT</strong>. Hivatalosan kizárólag az <strong>Egyházkerülettől (EREK
          iratterjesztő) vásárolt, sorszámozott nyugtatömb</strong> használható. Ez a felület
          egyelőre csak kipróbálásra és visszajelzés gyűjtésére szolgál.
        </p>
      </div>
