...
/**
 * Step 5 — web mód specifikus befejező.
 *
 * A standalone Step 5 (3 külön fetch: save-initial → initial-pull → write-license)
 * nem értelmes web módban — a user már bejelentkezett, nincs licensz-fájl írás
 * és nincs initial pull (Supabase-szel online vagyunk).
 *
 * Itt egyetlen server action fut (completeWizard), ami:
 ...
 */
export function Step5FinishWeb() {
