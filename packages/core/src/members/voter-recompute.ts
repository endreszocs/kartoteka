 ...
 * elcsúszó másolat (a repó ismert hibaosztálya). 2026-08-15 (desktop-paritás
 * 2. szelet): az apps/web/lib/members/voter-eligibility.ts-ből ide, a
 * @kartoteka/core-ba került, mert a desktop kivezetés-tükre is ugyanezt
 * hívja — a web a régi útvonalról re-exporttal éri el. Szerződés:
 *
