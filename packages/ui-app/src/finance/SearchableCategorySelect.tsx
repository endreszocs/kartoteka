...
/**
 * Kereshető kategória-választó (szamadasicel) — KÖZÖS web + desktop komponens
 * (2026-06-12, Endre #4 bank-import — az apps/web
 * `components/ui/searchable-category-select.tsx` átemelése változatlan
 * viselkedéssel; a BCR-import wizard közös törzse használja).
 *
