 ...
 *
 * 2026-08-15 (desktop-paritás 3. szelet): a közös csomagba emelve — a web
 * (`apps/web/lib/offline/recycle-bin-labels.ts` → re-export) és a desktop
 * Kuka (`apps/desktop/src/lib/recycle-bin.ts`) EGYAZON címkézőt használja.
 *
